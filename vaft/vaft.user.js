...
(function() {
    ...
    function declareOptions(scope) {
        ...
        scope.PlayerBufferingMinRepeatDelay = 10000;// Minimum delay (in milliseconds) between each pause/play (this is to avoid over pressing pause/play when there are genuine buffering problems)
        scope.V2API = false;
